        ...
        <div className="relative my-10 h-[352px] w-full  sm:my-16">
          ...
          <div className="relative h-full w-full">
            ...
            <Image
              ...
              width={1280}
              height={853}
              className="object-fit-cover absolute left-0 top-0 h-[352px] w-full rounded-[20px] object-cover saturate-200 sm:h-[352px] sm:w-full"
            />
            <div className="absolute left-0 top-0 h-full w-full rounded-[20px] from-black to-transparent bg-gradient-135 "></div>
          </div>
