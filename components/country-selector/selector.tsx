        ...
        <AnimatePresence>
          {open && (
            <motion.ul
              ...
              className="absolute z-10 mt-1 max-h-80 w-full rounded-md bg-white text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
              tabIndex={-1}
              role="listbox"
              aria-labelledby="listbox-label"
              ...
              <div className="sticky top-0 z-10 bg-white">
                <li className=" relative cursor-default select-none px-3 py-2 text-gray-900">
                  <input
                    ...
                    className="block h-10 w-full rounded-md border-gray-300 p-2 outline-[#808080] focus:border-[#808080] focus:ring-[#808080] sm:text-sm"
